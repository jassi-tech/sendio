...
const ENTERPRISE_FEATURES = [
  {
    ...
    desc: "SOC 2 Type II compliant with dedicated security reviews",
  },
  {
    icon: <Zap className="w-s-20 h-s-20" />,
    title: "Unlimited Volume",
    desc: "Send millions of emails with guaranteed infrastructure",
  },
  {
    icon: <Users className="w-s-20 h-s-20" />,
    title: "Dedicated Support",
    desc: "24/7 priority support with dedicated account manager",
  },
  {
    icon: <Globe className="w-s-20 h-s-20" />,
    title: "Global Infrastructure",
    desc: "Multi-region deployment with automatic failover",
  },
  {
    icon: <BarChart3 className="w-s-20 h-s-20" />,
    title: "Advanced Analytics",
    desc: "Custom dashboards and reports for your team",
  },
  {
    icon: <Lock className="w-s-20 h-s-20" />,
    title: "Custom SLA",
    desc: "99.99% uptime SLA with dedicated monitoring",
  },
];
      ...
      <section className="pt-s-120 pb-s-80 px-s-40">
        <div className="max-w-s-1000 mx-auto text-center">
          ...
          <p className="text-s-18 text-text-secondary max-w-s-700 mx-auto mb-s-48 leading-relaxed">
            Trusted by Fortune 500 companies. Get dedicated support, custom
            SLAs, and infrastructure built for scale.
          </p>
        ...
        <div className="max-w-s-1400 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-s-24">
            {ENTERPRISE_FEATURES.map((feature, idx) => (
              <div
                key={idx}
                className="card p-s-32 hover:border-text-muted/50 transition-all group"
              >
      ...
      <section className="py-s-100 px-s-40">
        <div className="max-w-s-900 mx-auto">
          <div className="card glass p-s-64 text-center">
            <h2 className="text-s-48 font-extrabold mb-s-24">
