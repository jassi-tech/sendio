...
const RESOURCES = [
    ...
    items: [
      {
        ...
        desc: "Set up your first SMTP connection in minutes",
        url: "#",
      },
      {
        title: "API Reference",
      ...
      {
        title: "Webhooks",
        desc: "Learn how to handle delivery events",
        url: "#",
      },
      {
        title: "Authentication",
        desc: "Secure your API keys and tokens",
        url: "#",
      },
    ],
  },
  {
    ...
    items: [
      {
        title: "Node.js SDK",
        desc: "Send emails using our JavaScript SDK",
        url: "#",
      },
      {
        title: "Python SDK",
        desc: "Python library for seamless integration",
        url: "#",
      },
      {
        title: "cURL Examples",
        desc: "Quick REST API examples using cURL",
        url: "#",
      },
      {
        title: "Postman Collection",
        desc: "Pre-built requests for testing",
        url: "#",
      },
    ],
  },
    ...
    items: [
      {
        ...
        desc: "Create and manage email templates",
        url: "#",
      },
      {
        title: "Delivery Best Practices",
        desc: "Improve email deliverability",
        url: "#",
      },
      {
        title: "Migration Guide",
        desc: "Move from other email services",
        url: "#",
      },
      {
        title: "Rate Limiting",
        desc: "Understand and optimize rate limits",
        url: "#",
      },
    ],
  },
    ...
    items: [
      {
        ...
        desc: "5-min overview of the platform",
        url: "#",
      },
      {
        title: "API Integration",
        desc: "Step-by-step API setup walkthrough",
        url: "#",
      },
      {
        title: "Webhooks Guide",
        desc: "Master event-driven architecture",
        url: "#",
      },
      {
            ...
            {RESOURCES.map((resource) => (
              <div key={resource.category} className="space-y-s-24">
                ...
                <div className="flex items-center gap-s-16 mb-s-32">
                  <div
                    className={`${resource.color} w-s-56 h-s-56 rounded-s-12 flex items-center justify-center flex-shrink-0`}
                  >
                    {resource.icon}
                  </div>
                  <h2 className="text-s-28 font-bold text-text-primary">
                    {resource.category}
                  </h2>
                </div>
        ...
        <div className="max-w-s-1200 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-s-24">
            <div className="card p-s-40 text-center hover:border-text-muted/50 transition-all">
              ...
              <a
                href="#"
                className="text-accent text-s-14 font-bold hover:underline"
              >
                Visit GitHub →
              </a>
            </div>
