...
const FAQ = [
  ...
  },
  {
    ...
    answer:
      "Free plan: 200 requests/month. Personal: 2,000/month. Professional: 5,000-10,000/month (adjustable). Business: 25,000-200,000/month. Enterprise plans have no limits.",
  },
  {
    question: "Can I use my own SMTP server?",
    answer:
      "Yes! That's one of our core features. You can connect unlimited sender profiles with your own AWS SES, Postmark, or custom SMTP servers.",
  },
  {
    question: "Is my data secure?",
    answer:
      "Absolutely. We use AES-256 encryption for all credentials, implement zero-knowledge architecture, and are SOC 2 Type II compliant for enterprise users.",
  },
  {
    question: "What's your support response time?",
    answer:
      "Free plans: 24-48 hours. Paid plans: 4-12 hours. Enterprise: 1 hour priority support with dedicated account manager available 24/7.",
  },
  {
    question: "Do you offer webhooks?",
    answer:
      "Yes, we support webhooks for delivery events, bounces, complaints, and more. Full webhook documentation is available in our API reference.",
  },
];
      ...
      <section className="pt-s-120 pb-s-80 px-s-40">
        <div className="max-w-s-1000 mx-auto text-center">
          ...
          <p className="text-s-18 text-text-secondary max-w-s-700 mx-auto leading-relaxed">
            Got questions? We have answers. Reach out to our support team or
        ...
        <div className="max-w-s-1200 mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-s-24 mb-s-100">
            ...
            <div className="card p-s-40 text-center hover:border-text-muted/50 transition-all">
              ...
              <a
                href="tel:+1234567890"
                className="text-info text-s-14 font-bold hover:underline"
              >
                +1 (234) 567-890 →
              </a>
            </div>
        ...
        <div className="max-w-s-1000 mx-auto">
          ...
          <div className="space-y-s-16">
            {[
              ...
              <div
                key={idx}
                className="card p-s-32 flex items-center justify-between"
              >
                <div className="flex items-center gap-s-16">
                  <Clock
                    className={`w-s-24 h-s-24 flex-shrink-0 ${item.icon}`}
                  />
                  <span className="text-s-16 font-bold text-text-primary">
                    {item.plan}
                  </span>
                </div>
                <span className="text-s-16 text-text-secondary">
                  {item.time}
                </span>
              </div>
            ))}
            ...
            {FAQ.map((item, idx) => (
              ...
              >
                <div className="p-s-32 flex items-center justify-between">
                  <h3 className="text-s-16 font-bold text-text-primary pr-s-24">
                    {item.question}
                  </h3>
                  <ChevronDown
      ...
      <section className="py-s-100 px-s-40">
        <div className="max-w-s-700 mx-auto">
          <div className="card p-s-64">
            <h2 className="text-s-32 font-bold mb-s-8 text-center">
              Still need help?
            </h2>
            ...
            <form className="space-y-s-24">
              <div>
                <label className="block text-s-14 font-bold text-text-primary mb-s-8">
                  Full Name
                </label>
                <input
                  type="text"
